...
class SupervisorStoriesScreen extends StatefulWidget {
  ...
  @override
  State<SupervisorStoriesScreen> createState() => _SupervisorStoriesScreenState();
}
...
class _SupervisorStoriesScreenState extends State<SupervisorStoriesScreen> {
  ...
  // ✅ Preferred yellow
  static const Color kMainYellow = Color.fromRGBO(255, 201, 92, 1);
  ...
  void _applyFilters() {
    List filtered = List.from(_stories);
  ...
  void _confirmPublishStory(String storyId) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("Are you sure you want to publish this story for all children?"),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: kMainYellow),
            child: const Text(
              "Publish",
  ...
  int _webCrossAxisCount(double w) {
    // Responsive columns on web
    if (!kIsWeb) return 2;
    if (w >= 1400) return 4;
    if (w >= 1050) return 3;
    return 2;
    ...
    return HomePage(
      ...
      child: LayoutBuilder(
        builder: (context, c) {
          ...
          final cols = _webCrossAxisCount(c.maxWidth);
                  ...
                  Padding(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.search, color: kMainYellow),
                        filled: true,
                        ...
                        : _filteredStories.isEmpty
                            ...
                            : GridView.builder(
                                ...
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  ...
                                  crossAxisSpacing: 16,
                                  mainAxisSpacing: 16,
                                  childAspectRatio: kIsWeb ? 0.85 : 0.8,
                                ),
                                itemBuilder: (context, index) {
                                  ...
                                  final String childName = story['childId']?['name'] ?? "Unknown child";
    ...
    return Padding(
      ...
      child: ChoiceChip(
        ...
        labelStyle: TextStyle(
          color: _selectedStatus == value ? Colors.white : Colors.black87,
          fontWeight: FontWeight.w600,
        ),
        onSelected: (selected) {
          setState(() {
...
class _SupervisorStoriesScreenState extends State<SupervisorStoriesScreen> {
  ...
  // ✅ Status colors (keep meaning, but warmer for pending/needs_edit)
  Color _statusColor(String status) {
    switch (status) {
      case "approved":
        return Colors.green;
