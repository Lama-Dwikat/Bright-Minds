...
class _ChildDrawingCanvasScreenState extends State<ChildDrawingCanvasScreen> {
  ...
  Future<void> _stopActivityTiming() async {
    if (_activitySessionId == null) return;
    ...
    try {
      ...
      if (resp.statusCode == 200) _activitySessionId = null;
    } catch (e) {
  ...
  Future<void> _loadExistingDrawing() async {
    try {
      ...
      final url = Uri.parse("${getBackendUrl()}/api/drawing/last/${widget.activityId}");
  ...
  Future<void> _sendToSupervisor() async {
    ...
    try {
      ...
      final url = Uri.parse("${getBackendUrl()}/api/drawing/submit/$_lastSavedDrawingId");
  ...
  // ✅ This is the controls panel (mobile bottom OR web right panel)
  Widget _controlsPanel(List<Color> colorOptions) {
    return Column(
            ...
            children: [
              ...
              Expanded(
                child: Slider(
                  ...
                  min: 30,
                  max: 120,
                  onChanged: (v) => setState(() => selectedShapeSize = v),
                ),
              ),
            ],
          ),
            ...
            children: [
              ...
              Expanded(
                child: Slider(
                  ...
                  min: 28,
                  max: 90,
                  onChanged: (v) => setState(() => selectedStickerSize = v),
                ),
              ),
            ],
          ),
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          // ✅ WEB LAYOUT: canvas left + tools right
          final bool isWebWide = kIsWeb && w >= 1000;
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: AspectRatio(
                            aspectRatio: 3 / 4, // ✅ شكل “طولي” على الويب
                            child: _canvasArea(),
                          ),
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: SingleChildScrollView(
                          child: Container(
                            ...
                            child: _controlsPanel(colorOptions),
                          ),
                        ),
                      ),
                    ],
          ...
          // ✅ MOBILE/TABLET LAYOUT: same as your original (canvas + bottom controls)
          return Column(
            children: [
              Expanded(
                child: Padding(
