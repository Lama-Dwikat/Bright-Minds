...
class _ChildDrawingActivitiesScreenState
  ...
  Future<void> _startSectionTiming() async {
    try {
      ...
      if (resp.statusCode == 201) {
        ...
        debugPrint(
            "start section timing failed: ${resp.statusCode} ${resp.body}");
      }
    } catch (e) {
  ...
  Future<void> _stopSectionTiming() async {
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        debugPrint(
            "stop section timing failed: ${resp.statusCode} ${resp.body}");
      }
    } catch (e) {
  ...
  double _maxContentWidth(double w) {
    if (w >= 900) return 1100; // وسّط الصفحة على الويب
    return w;
  }
  ...
  double _childAspectRatioForWidth(double w) {
    // على الويب نخلي الكارد أطول شوي عشان الصورة/العنوان يطلعوا حلوين
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  _categoryCard(
                    ...
                    onTap: () =>
                        _openType("surpriseColor", "Drawing by Reference"),
                  ),
                ],
              ),
            ),
