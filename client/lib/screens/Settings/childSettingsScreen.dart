...
class _ChildSettingsScreenState extends State<ChildSettingsScreen> {
  ...
  // ✅ Web-safe backendUrl (بدون Platform)
  ...
  Future<void> _fetchParentAndSupervisor() async {
    ...
    if (parentId != null && parentId.isNotEmpty) {
      ...
      if (mounted) setState(() => _parent = null);
    }
    ...
    if (supervisorId != null && supervisorId.isNotEmpty) {
      ...
      if (mounted) setState(() => _supervisor = null);
    }
  }
  ...
  Future<void> _editChildField(String field, String label) async {
    ...
    final controller =
        TextEditingController(text: (_child?[field] ?? "").toString());
      ...
      child: Row(
        children: [
          ...
          if (onEdit != null)
            IconButton(
              onPressed: onEdit,
              icon: const Icon(Icons.edit, color: Color(0xFFFFC95C)),
              tooltip: "Edit",
            ),
        ],
      ),
  ...
  Widget _personCard({
    ...
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(
            backgroundColor: const Color(0xFFFFD98C).withOpacity(0.25),
            child: Icon(icon, color: const Color(0xFF7A4A3E)),
          ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                _avatar(
                                  childName.isNotEmpty ? childName[0] : "C",
                                  _childAvatarBytes,
                                ),
                          ...
                          _infoRow(title: "Email", value: childEmail),
                          const SizedBox(height: 12),
                          _infoRow(
                            title: "Birth Date",
                            value: dobText,
  ...
  Widget _avatar(String fallbackLetter, Uint8List? bytes) {
    return CircleAvatar(
      ...
      child: (bytes == null)
          ? Text(
              fallbackLetter.toUpperCase(),
              style: const TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color(0xFF9A5A4A)),
            )
          : null,
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          CircleAvatar(
            backgroundColor: const Color(0xFFFFD98C).withOpacity(0.25),
            child: Icon(icon, color: Color(0xFF7A4A3E)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
