...
class _SearchExternalImagesScreenState extends State<SearchExternalImagesScreen> {
  ...
  String getBackendUrl() {
    if (kIsWeb) 
    //return "http://192.168.1.63:3000"; // عدليها لو بدك
   return "http://localhost:3000";
    return "http://10.0.2.2:3000"; // Android emulator (mobile)
  }
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.softSunYellow.withOpacity(0.15),
                  borderRadius: BorderRadius.circular(14),
                ),
                child: const Icon(
                  Icons.grid_on_rounded,
                  color: AppColors.softSunYellow,
                ),
              ),
                ...
                children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(14),
                            border: Border.all(
                              color: AppColors.softSunYellow.withOpacity(0.35),
                            ),
                          ),
                          child: Text(
                            "$value",
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      activeTrackColor: AppColors.softSunYellow,
                      inactiveTrackColor:
                          AppColors.softSunYellow.withOpacity(0.25),
                      thumbColor: AppColors.softSunYellow,
                      overlayColor: AppColors.softSunYellow.withOpacity(0.15),
                      trackHeight: 4.5,
                      thumbShape:
  ...
  Future<void> uploadFromDevice() async {
    ...
    try {
      ...
      // ✅ web uses bytes, mobile uses fromPath
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              AppColors.softSunYellow.withOpacity(0.18),
              Colors.white,
            ],
          ),
        ),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        // ✅ Grid inside scroll: use shrinkWrap + never scroll
                        GridView.builder(
                          ...
                          gridDelegate:
                            ...
                            crossAxisSpacing: 12,
                            mainAxisSpacing: 12,
                            childAspectRatio: kIsWeb ? 1.05 : 0.92,
                          ),
                          itemBuilder: (_, i) {
                            final item = types[i];
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 44,
            decoration: BoxDecoration(
              color: AppColors.softSunYellow.withOpacity(0.18),
              borderRadius: BorderRadius.circular(14),
            ),
            child:
                const Icon(Icons.tips_and_updates, color: AppColors.softSunYellow),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color:
                                selected ? AppColors.softSunYellow : Colors.black12,
                          ),
                        ),
                        child: Icon(
                          selected ? Icons.check : Icons.circle_outlined,
                          color:
                              selected ? AppColors.softSunYellow : Colors.black38,
                          size: 18,
                        ),
                      ),
                    ),
                    if (selected)
                      Positioned(
                        ...
                        right: 0,
                        top: 0,
                        child: Container(height: 4, color: AppColors.softSunYellow),
                      ),
                  ],
                ),
              ),
            ...
            return Column(
              ...
              children: [
                ...
                SliderTheme(
                  data: SliderTheme.of(context).copyWith(
                    activeTrackColor: AppColors.softSunYellow,
                    inactiveTrackColor: AppColors.softSunYellow.withOpacity(0.25),
                    thumbColor: AppColors.softSunYellow,
                    overlayColor: AppColors.softSunYellow.withOpacity(0.15),
                    trackHeight: 4.5,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.tips_and_updates, color: AppColors.softSunYellow),
          ),
          const SizedBox(width: 10),
          Expanded(
            child: Text(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          shape: BoxShape.circle,
                          border: Border.all(
                            color: selected ? AppColors.softSunYellow : Colors.black12,
                          ),
                        ),
                        child: Icon(
                          selected ? Icons.check : Icons.circle_outlined,
                          color: selected ? AppColors.softSunYellow : Colors.black38,
                          size: 18,
                        ),
                      ),
                    ),
